...
class FinvizSpider(scrapy.Spider):
    ...
    financial_url = screener_url + financial_screen + not_small_with_good_dividend
    ownership_url = screener_url + ownership_screen + not_small_with_good_dividend
    ...
    def start_requests(self):
        ...
        # uncomment to scrap other indicators
